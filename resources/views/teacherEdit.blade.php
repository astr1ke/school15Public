...
<div class="content">
    <div class="wrapper">
        ...
        <form id="form" class="blocks" action="/teacherEditPost" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="fld">
                <p>
                    <label >ФИО:</label>
                    <input type="text" class="text" name="FIO" value="{{$teacher->FIO}}" />
                </p>
                <p><label>Специальн.</label>
                    <input type="text" class="text" name="specialization" value="{{$teacher->specialization}}"/>
                </p>
            </div>
            <br/>
            ...
            <br/>
            <p class="area">
                <textarea class="txtarea" name="about" rows="10" cols="80">{!!$teacher->about!!}</textarea>
            </p>
            <div class="fld">
                <p>
