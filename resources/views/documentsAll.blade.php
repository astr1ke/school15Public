                                            ...
                                            <div class="entry-meta">
                                                ...
                                                <!--Кнопка удалить-->
                                                    <form action="/documentDelete/{{$document->id}}" method="post">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}
                                                        <button  class="btn fa" style="margin-top: 5px; margin-left: 5px; width: 100px " value="Удалить меню">Удалить меню</button>
                                                    </form>
                                                    <!--Кнопка редактировать-->

                                                    <form action="/documentEditOpen/{{$document->id}}"  >
                                                        <button   class="btn fa" style="margin-top:5px; margin-left: 5px; width: 100px" value="Редактировать меню">Редактир меню</button>
                                                    </form>
                                                @endif
                                            </div>
                                        </div>
